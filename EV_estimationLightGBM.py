...
# The lgb model the params for EV analysis for Genetics, clinical factors, lifestyle factors:
# learning_rate=0.01, max_depth =5, feature_fraction=0.8, num_leaves = 25, min_data_in_leaf=15, metric='l2', early_stopping_rounds=None, n_estimators=200, bagging_fraction=0.9,
# bagging_freq=5, num_threads=1, verbose=-1, silent=True
# The lgb model the params for EV analysis for Gut-Microbiome analysis: learning_rate': 0.005, 'feature_fraction': 0.2,'min_data_in_leaf': 15, 'metric': 'l2',
# 'early_stopping_rounds': None, 'n_estimators': 2000,'bagging_fraction': 0.8, 'bagging_freq': 1, 'num_threads': 1, 'verbose': -1, 'silent': True
lgb = lgb.LGBMRegressor(learning_rate=0.005, feature_fraction=0.2, min_data_in_leaf=15,
                        metric='l2', early_stopping_rounds=None, n_estimators=2000, bagging_fraction=0.8,
                        bagging_freq=1, num_threads=1, verbose=-1, silent=True)
